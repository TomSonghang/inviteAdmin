  ...
  <div class="contextWrap postWrap">
    <div>
      <div class="titleBox">
        ...
        <p class="descripts">职位名称和职位类型发布后不可修改，请准确填写</p>
      </div>
      <div class="inputBox">
        <div class="itemBox">
          ...
          <p v-show="action == 'edit' && serviceCode == '普通职位'">
            如需转精品可在职位管理列表里操作哦~
          </p>
        </div>
    ...
    <div class="partTwo">
      <div class="titleBox">
        <div class="titles">详细信息</div>
        <p class="descripts">详细的职位介绍信息能帮助你更快找到合适的候选人</p>
      </div>
      <div class="inputBox">
        <div class="itemBox">
        ...
        <div class="itemBox">
          ...
          <div>
            ...
            <mul-select
              :mulData="fixWelfareOption"
              :welfare.sync="welfare"
            ></mul-select>
          </div>
          <!-- <div>
        ...
        <el-button type="primary" class="companyBg mar120" @click="handleCreate"
          >发布职位</el-button
        >
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      maxPrice: "",
      checkPrice: "元/月",
      priceOptions: ["元/小时", "元/日", "元/月", "元/年", "面议"],
  ...
  methods: {
    ...
    handleChangeAction() {
      ...
      if (this.action == "edit") {
        this.$confirm(
          `您的精品职位还剩${this.jpNum}次, 此操作会扣减1次额度,是否继续?`,
          "提示",
          {
    ...
    handleCreate() {
      ...
      if (this.action === "add") {
        //如果是新增，则提示
        this.$confirm(
          "职位发布后，职位名称和职位类型将不能修改，并扣减一次发布额度，请确认后发布?",
          "提示",
          {
            confirmButtonText: "确定",
            cancelButtonText: "取消",
